...
export function SerializeNumberHash(value) {
...
export class L2BlockCommittedInfo {
  constructor(reader, { validate = true } = {}) {
    this.view = new DataView(assertArrayBuffer(reader));
    if (validate) {
      this.validate();
...
export function SerializeL2BlockCommittedInfo(value) {
...
export function SerializeLogItem(value) {
  const buffers = [];
...
export function SerializeLogItemVec(value) {
...
export function SerializeTxReceipt(value) {
  const buffers = [];
...
export function SerializeWithdrawalReceipt(value) {
  const buffers = [];
  buffers.push(SerializeAccountMerkleState(value.post_state));
  return serializeTable(buffers);
}
...
export function SerializeSMTBranchKey(value) {
...
export function SerializeSMTBranchNode(value) {
  const buffers = [];
...
export function SerializeSMTMergeValue(value) {
  switch (value.type) {
  case "SMTValue":
    {
...
export function SerializeSMTMergeWithZero(value) {
...
export function SerializeSMTValue(value) {
