...
export function SerializeOutPointVec(value: Array<object>): ArrayBuffer;
...
export function SerializeNumberHash(value: object): ArrayBuffer;
...
export function SerializeL2BlockCommittedInfo(value: object): ArrayBuffer;
export class L2BlockCommittedInfo {
  ...
  getNumber(): Uint64;
  getBlockHash(): Byte32;
  getTransactionHash(): Byte32;
}

export function SerializeTransactionKey(value: CanCastToArrayBuffer): ArrayBuffer;
...
export function SerializeTransactionInfo(value: object): ArrayBuffer;
...
export function SerializeLogItem(value: object): ArrayBuffer;
export class LogItem {
  constructor(reader: CanCastToArrayBuffer, options?: CreateOptions);
  validate(compatible?: boolean): void;
  getAccountId(): Uint32;
  getServiceFlag(): number;
  getData(): Bytes;
}

export function SerializeLogItemVec(value: Array<object>): ArrayBuffer;
export class LogItemVec {
  constructor(reader: CanCastToArrayBuffer, options?: CreateOptions);
  validate(compatible?: boolean): void;
  indexAt(i: number): LogItem;
  length(): number;
}

export function SerializeTxReceipt(value: object): ArrayBuffer;
export class TxReceipt {
  constructor(reader: CanCastToArrayBuffer, options?: CreateOptions);
  validate(compatible?: boolean): void;
  getTxWitnessHash(): Byte32;
  getPostState(): AccountMerkleState;
  getReadDataHashes(): Byte32Vec;
  getLogs(): LogItemVec;
}

export function SerializeWithdrawalReceipt(value: object): ArrayBuffer;
